<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = $_COOKIE['WEB_UPLOAD_DIR']; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = $_COOKIE['WEB_UPLOAD_DIR']; // absolute or relative from this script path.
