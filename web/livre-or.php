...
<title>Coraloisirs - Livre d'or - Fabricant de constructions en bois, Abris de jardin, Chalets - Orléans et Saint Denis en VAL</title>
<!-- InstanceEndEditable -->
    ...
    <div id="site">   
        ...
        <div id="contenu">
            <h1><!-- InstanceBeginEditable name="Titre" -->
	            <img src="images/titres/livre-or.jpg" alt="CoraLoisir - Livre d'or" width="904" height="57" />
            <!-- InstanceEndEditable -->
            </h1>
