...
<title>Coraloisirs - Fabricant de constructions en bois, Abris de jardin, Chalets - Orléans et Saint Denis en VAL</title>
<!-- InstanceEndEditable -->
    ...
    <div id="site">
        ...
        <div id="contenu">
            <h1><!-- InstanceBeginEditable name="Titre" -->
	            <img src="images/titres/actualites.jpg" alt="CoraLoisir - Actualités" width="904" height="57" />
            <!-- InstanceEndEditable -->
            </h1>
